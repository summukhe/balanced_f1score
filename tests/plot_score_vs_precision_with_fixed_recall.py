...
if __name__ == "__main__":
    ...
    pdf = pd.melt(df[[anchor_column, 'recall', 'coverage', 'fscore', 'pa', 'kpa', 'fpa']],
                  id_vars=['coverage', 'recall', anchor_column],
